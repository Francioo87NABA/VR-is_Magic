...
Shader "Tornado_Dissolve"
{
	Properties
	{
		...
		_Noysspeed("Noys speed", Vector) = (0,0,0,0)
	...
	SubShader
	{
		...
		void surf( Input i , inout SurfaceOutputStandard o )
		{
			...
			float simplePerlin2D5 = snoise( ( temp_output_1_0_g1 + ( appendResult19_g1 * ( dotResult12_g1 * float2( 10,10 ) ) ) + ( mulTime1 * _Noysspeed ) )*_Grandezzanois );
			simplePerlin2D5 = simplePerlin2D5*0.5 + 0.5;
			float2 temp_cast_0 = (_TwirlCenter).xx;
			float2 center45_g1 = temp_cast_0;
			...
			float2 temp_cast_1 = (( mulTime1 * _Twirlofset )).xx;
			...
			o.Albedo = ( _Color0 * temp_output_20_0 ).rgb;
...
/*ASEBEGIN
Version=18000
0;0;1920;1059;2001.454;371.7209;1.760442;True;False
...
Node;AmplifyShaderEditor.Vector2Node;2;-916.9995,368.44;Inherit;False;Property;_Noysspeed;Noys speed;1;0;Create;True;0;0;False;0;0,0;0,0;0;3;FLOAT2;0;FLOAT;1;FLOAT;2
...
Node;AmplifyShaderEditor.FunctionNode;6;-484.3593,382.5599;Inherit;False;Radial Shear;-1;;1;c6dc9fc7fa9b08c4d95138f2ae88b526;0;4;1;FLOAT2;0,0;False;2;FLOAT2;0,0;False;3;FLOAT2;0,0;False;4;FLOAT2;0,0;False;1;FLOAT2;0
...
Node;AmplifyShaderEditor.SimpleMultiplyOpNode;20;218.4639,629.9708;Inherit;False;2;2;0;FLOAT;0;False;1;FLOAT;0;False;1;FLOAT;0
...
Node;AmplifyShaderEditor.SimpleMultiplyOpNode;13;348.285,-18.23951;Inherit;False;2;2;0;COLOR;0,0,0,0;False;1;FLOAT;0;False;1;COLOR;0
...
ASEEND*/
//CHKSM=77D13E02D873907B2688863589BBCFB3A04FD459